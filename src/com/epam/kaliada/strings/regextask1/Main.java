...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(wordsSorter.splitIntoSentencesAndSortByLength());
//
        LexemeSorter lexemeSorter = new LexemeSorter(string, 'a');
        System.out.println(lexemeSorter.splitIntoSentencesAndsortLexemesByNumberOfEnteredSymbol());
