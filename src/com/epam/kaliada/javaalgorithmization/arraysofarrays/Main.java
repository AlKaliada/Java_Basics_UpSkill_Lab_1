...
public class Main {
    public static void main(String[] args) throws IOException{
        ...
        //Task3.printStringKColumnPInMatrix(task3, 3, 3);

        //Task4
        //int n = 4;
        //if (n % 2 == 0){
        //    System.out.println(Arrays.deepToString(Task4.createMatrix(n)));
        //}else {
        //    throw new IllegalArgumentException("enter even n");
        //}

        //Task5
        //int n = 4;
        //if (n % 2 == 0){
        //    System.out.println(Arrays.deepToString(Task5.createMatrix(n)));
        //}else {
        //    throw new IllegalArgumentException("enter even n");
        //}
        ...
        //int n = 8;
        //if (n % 2 == 0){
        //    System.out.println(Arrays.deepToString(Task6.createMatrix(n)));
        //}else {
        //    throw new IllegalArgumentException("enter even n");
        //}
        ...
        //int n = 8;
        //if (n > 0){
        //    System.out.println(Arrays.deepToString(Task7.createMatrixAndCountPositiveElements(n)));
        //}else {
        //    throw new IllegalArgumentException("enter even n");
        //}
        ...
        //Task8
//        int[][] task8 = {{1 ,2, 3, -1, 6}, {2, 6, 1, 3, 0}};
//
//        if (CheckMatrix.isMatrix(task8)){
//            System.out.println("Enter the column numbers to be replaced");
//            int m = Integer.parseInt(reader.readLine());
//            int n = Integer.parseInt(reader.readLine());
//            if (m >= 0 && m < task8[0].length && n >= 0 && n < task8[0].length){
//                Task8.changeColumnsInMatrix(task8, m, n);
//                System.out.println(Arrays.deepToString(task8));
//            }else {
//                throw new IllegalArgumentException("You entered incorrect numbers of columns");
//            }
//        }else {
